  ...
  "organizer-text-sm organizer-font-medium organizer-transition-colors",
  {
    variants: {
      variant: {
        ...
        surface:
          "organizer-px-3 organizer-py-1.5 organizer-rounded-md organizer-bg-bg-surface hover:organizer-bg-bg-input organizer-text-text-primary organizer-cursor-pointer",
        cancel:
        ...
        icon: "organizer-p-2 organizer-rounded-lg organizer-bg-bg-input organizer-text-text-primary hover:organizer-bg-bg-surface-hover organizer-flex organizer-items-center organizer-justify-center organizer-cursor-pointer"
      }
    },
    defaultVariants: {
      variant: "default"
